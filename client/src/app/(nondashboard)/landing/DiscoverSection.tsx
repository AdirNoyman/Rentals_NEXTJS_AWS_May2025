      ...
      <div className='max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16'>
        <motion.div variants={itemVariants} className='my-12 text-center'>
          ...
          <p className='mt-4 text-lg text-gray-600'>
            Find your perfect rental with our advanced search tools and
          </p>
          <p className='mt-2 text-gray-500 max-w-3xl mx-auto'>
            Search and filter rental listings to find the perfect place for you. 
            Our platform offers a wide range of options to suit your needs, from
            apartments to houses. With our user-friendly interface, you can easily
            browse through listings, view photos, and read detailed descriptions.
          </p>
        </motion.div>
